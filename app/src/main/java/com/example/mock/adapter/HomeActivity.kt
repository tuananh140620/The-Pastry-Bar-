...
import com.example.mock.adapter.BottomMenuAdapter
...
class HomeActivity : AppCompatActivity() {
    private lateinit var vpa : BottomMenuAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resList.add(Restaurant("0", "Hanoi",21.01093977370695,105.79947760168453))
        resList.add(Restaurant("1", "HoChiMinh",10.771028861387272, 106.69871834551199))
        getLastLocation()
        ...
        vpa = BottomMenuAdapter(supportFragmentManager)
