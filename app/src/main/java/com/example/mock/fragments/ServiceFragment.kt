...
import com.example.mock.activities.MainActivity
import com.example.mock.adapter.HistoryActivity
//import com.example.mock.adapter.HistoryActivity
...
class ServiceFragment : Fragment() {
    ...
    override fun onStart(){
        ...
        signoutButton.setOnClickListener{
            ...
            startActivity(intent)
            val myToast = Toast.makeText(this.context, "Hello", Toast.LENGTH_SHORT)
            myToast.show()
        }
    }
